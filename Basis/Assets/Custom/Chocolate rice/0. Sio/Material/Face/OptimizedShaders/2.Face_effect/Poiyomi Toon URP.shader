Shader "Hidden/Locked/.poiyomi/Poiyomi Toon URP/3493b59c7b370084bb8d9664b7cbb6e0"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				if (2.0)
				{
					...
					float alphaMask = 1;
					#endif
					alphaMask = saturate(alphaMask * 1.0 + (0.0 ? -0.02 * - 1 : -0.02));
