Shader "Hidden/Locked/.poiyomi/Poiyomi Pro URP/11f206cb032b669409480a8b313ae29d"
{
	Properties
	{
		...
		[Helpbox(1)] _PPHelp ("This section is intended for real time adjustments through animations at runtime. Therefore, these should not be changed in Unity.", Int) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			void PoiCalculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				#endif
				float shadowStrength = 0.859 * poiLight.shadowMask.r;
				#ifdef POI_PASS_OUTLINE
